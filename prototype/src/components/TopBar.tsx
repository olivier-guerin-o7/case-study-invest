...
export default function TopBar({ onToast }: { onToast?: () => void }) {
  return (
    <div className="flex items-center justify-between px-6 pt-1 pb-4">
      ...
      <button
        onClick={() => onToast?.()}
        className="flex h-10 w-10 items-center justify-center rounded-full bg-surface-prominent active:opacity-70 transition-opacity"
      >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={() => onToast?.()}
          className="relative flex h-10 w-10 items-center justify-center active:opacity-70 transition-opacity"
        >
        ...
        <button
          onClick={() => onToast?.()}
          className="flex h-10 w-10 items-center justify-center active:opacity-70 transition-opacity"
        >
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" className="text-white/50">
